...
<div id="main">
    <form name = "registration" action="add_employee.php" method="POST" >
...
if (isset($_POST['Submit'])){
    ...
    $sqlinsert = "INSERT INTO user (user_name,password,fName,lName,phone,email,userType) VALUES ('$username','$hash','$fname','$lname','$phone','$email',1);";
